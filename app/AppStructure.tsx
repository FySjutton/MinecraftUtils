...
export const tools: ToolCategory[] = [
    ...
    },
    {
        ...
        pages: [
            ...
            { name: "Banner Generator", url: "banner-generator", icon: "banner", description: "Create banners through an interactive editor with command and crafting instructions output.", type: "alpha" },
